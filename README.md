# ng-nawah
This repo is the home of the source code of `ng-nawah`, [Nawah](https://github.com/nawah-io/nawah_docs) SDK for Angular.
...
## How to Use
1. Import `NgNawahModule` in your module imports.
